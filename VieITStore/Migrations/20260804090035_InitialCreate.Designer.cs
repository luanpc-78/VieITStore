...
namespace VieITStore.Migrations
{
    ...
    [Migration("20260804090035_InitialCreate")]
            ...
            modelBuilder.Entity("VieITStore.Models.Entities.NguoiDung", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HoTen = "Quản trị viên",
                            MatKhauHash = "$2a$11$Qk5L1U3F3Z3Q3Z3Q3Z3Q3O",
                            NgayTao = new DateTime(2026, 8, 4, 16, 0, 32, 299, DateTimeKind.Local).AddTicks(2163),
                            TenDangNhap = "admin",
                            TrangThai = true,
                            VaiTro = 1
                        },
                        new
                        {
                            ...
                            MatKhauHash = "$2a$11$Qk5L1U3F3Z3Q3Z3Q3Z3Q3O",
                            NgayTao = new DateTime(2026, 8, 4, 16, 0, 32, 301, DateTimeKind.Local).AddTicks(4783),
